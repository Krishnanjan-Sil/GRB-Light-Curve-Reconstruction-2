# -*- coding: utf-8 -*-
"""GitHub_QSS_GRB_1a.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1W2H48_DlyYZkKB4nUkZRg3x5If_14QRx

Author: Krishnanjan Sil

GitHub profile link: https://github.com/Krishnanjan-Sil
"""
...
from scipy.interpolate import UnivariateSpline  # For fitting quadratic smoothing splines
...
folder_path = "/content/drive/MyDrive/QSS_test-1a/Saved_Outputs/"
...
def run_model(grb_name):
    ...
    fits a quadratic smoothing spline via scipy.interpolate.UnivariateSpline,
    ...
    # -------------------------------------------------------------------------------
    def train_spline():
        print("\n----- TRAINING QUADRATIC SMOOTHING SPLINE (SciPy) -----\n")
        ...
        plt.title(f'Quadratic Smoothing Spline on {grb_name}', fontsize=18)  # Plot title
...
# Loop through each GRB and run the model
GRBs = [
    'GRB050128', 'GRB050502B', 'GRB050607', 'GRB050712', 'GRB050713A'
    # Similarly add the rest of GRBs
    ]
